...
export default function Job({
  ...
  return (
    <div
      ...
      className="w-[95%] flex items-start rounded-2xl cursor-pointer hover:bg-gray-100 px-6 py-4 shadow-md shadow-gray-400 relative gap-4 border-[1px] border-gray-400/[.5]"
    >
